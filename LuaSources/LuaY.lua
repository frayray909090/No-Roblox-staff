...
local luaX =
    loadstring(
    game:HttpGet("https://raw.githubusercontent.com/Zer0ids/Globale-executor/main/LuaSources/LuaX.lua", true)
)()
local luaK =
    loadstring(
    game:HttpGet("https://raw.githubusercontent.com/Zer0ids/Globale-executor/main/LuaSources/LuaK.lua", true)
)(luaY)
local luaP =
    loadstring(
    game:HttpGet("https://raw.githubusercontent.com/Zer0ids/Globale-executor/main/LuaSources/LuaP.lua", true)
)()
...
function luaY:forbody(ls, base, line, nvars, isnum)
    ...
    local endfor =
        isnum and luaK:codeAsBx(fs, "OP_FORLOOP", base, luaK.NO_JUMP) or luaK:codeABC(fs, "OP_TFORLOOP", base, 0, nvars)
